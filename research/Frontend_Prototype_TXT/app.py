...
def index():
    ...
    return render_template("templates/index.html", vorgestern=max_date, min_date=min_date)
...
def validation():
    ...
    return render_template("templates/validation.html", vorgestern=max_date, min_date=min_date)
